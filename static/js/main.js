...
async function initApp() {
  ...
  preloaderContainer.innerHTML = await loadPartial(
    "/static/html/partials/preloader.partial.html"
  );

  // Загружаем форму авторизации
  const authContainer = document.getElementById("auth-container");
  authContainer.innerHTML = await loadPartial(
    "/static/html/partials/main.partial.html"
  );
